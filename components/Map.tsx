            ...
            >
                ...
                {showInfoWindow && (
                    <InfoWindow position={center} onCloseClick={() => setShowInfoWindow(false)}>
                        <div>
                            <h3 className="font-bold">SEWYCA</h3> {/* Replace with your hotel name */}
                            <p>Society for Empowerment of Women Youth and Children for Action</p> {/* Add additional details if needed */}
                        </div>
                    </InfoWindow>
                )}
            </GoogleMap>
